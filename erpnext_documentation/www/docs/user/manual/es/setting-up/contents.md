...
Aquí se encontrarán todas las opciones globales de configuración. Para configuraciones de módulo se debe ingresar a cada uno de ellos. 
...
1. [Descargar Copias de Seguridad](/docs/user/manual/es/setting-up/data/download-backup)
...
1. [Acciones de flujos de trabajo](/docs/user/manual/es/setting-up/workflow-actions)
1. [Estados de flujos de Trabajo](/docs/user/manual/es/setting-up/workflow-state)
1. [Reglas de Asignación](/docs/user/manual/es/automation/assignment-rule)

### 1.6 Correo Electrónico y Mensajes de Texto
1. [Dominio de Correo Electrónico](/docs/user/manual/es/setting-up/email/email-domain)
1. [Cuentas de Correo Electrónico](/docs/user/manual/es/setting-up/email/email-account)
1. [Bandeja de Entrada](/docs/user/manual/es/setting-up/email/email-inbox)
1. [Plantilla de Correo Electrónico](/docs/user/manual/es/setting-up/email/email-template)
...
1. [Email Dropbox](/docs/user/manual/es/setting-up/email/email-dropbox)
...
### 1.8 Privacidad de Datos
1. [Solicitud de descarga de datos personales](/docs/user/manual/es/setting-up/personal-data-download)
1. [Solicitud de eliminación de datos personales](/docs/user/manual/es/setting-up/personal-data-deletion)

## 2. Artículos
### 2.1 Configuración Básica
1. [Cambiar Contraseña](/docs/user/manual/es/setting-up/articles/change-password)
1. [Editar Documento Validado](/docs/user/manual/es/setting-up/articles/edit-submitted-document)
1. [Eliminar Documento Validado](/docs/user/manual/es/setting-up/articles/delete-submitted-document)
1. [Renombrar Usuario](/docs/user/manual/es/setting-up/articles/rename-user)
1. [Diferencia entre Usuario de Sistema y Usuario de Sitio Web](/docs/user/manual/es/setting-up/articles/difference-between-system-user-and-website-user)
1. [Membrete](/docs/user/manual/es/setting-up/articles/managing-letterhead)
1. [Informe Preparado](/docs/user/manual/es/setting-up/articles/prepared-report)

### 2.2 Datos y Administración

1. [Sobrescribir Datos usando la Herramienta de Importación de Datos](/docs/user/manual/es/setting-up/articles/overwriting-data-from-data-import-tool)
1. [Administrar Documentos con Estructura de Árbol](/docs/user/manual/es/setting-up/articles/managing-tree-structure-masters/)
1. [Administrar Niveles de Permisos](/docs/user/manual/es/setting-up/articles/managing-perm-level/)

### 2.3 Errores

1. [Errores de Correo Electrónico](/docs/user/manual/es/setting-up/articles/email-error)
1. [Resolución de Problemas de Errores de Permisos](/docs/user/manual/es/setting-up/articles/report-permission-error)

### 2.4 Otras acciones

1. [Valor Actual de Secuencias e identificadores](/docs/user/manual/es/setting-up/articles/naming-series-current-value)
1. [Configurar Autenticación de Dos Factores](/docs/user/manual/es/setting-up/articles/setup-two-factor-authentication)
